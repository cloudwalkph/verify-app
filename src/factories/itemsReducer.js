import {setSyncStatus, mergeItems} from '../utils/itemSync';
import {addOrReplaceItem, replaceById, removeById, itemComparator} from '../utils/item';

export default function itemsReducer(types) {
